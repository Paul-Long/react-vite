...
interface BackpackWallet extends Wallet {
  isBackpack?: boolean;
}

interface BackpackWalletWindow extends Window {
  backpack?: BackpackWallet;
}

declare const window: BackpackWalletWindow;

export class BackpackWalletAdapter extends BaseAdapter {
  name: string = 'Backpack';
  url: string = 'https://backpack.app';
  icon =
