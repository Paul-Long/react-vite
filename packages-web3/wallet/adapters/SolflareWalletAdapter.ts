...
interface SolflareWallet extends Wallet {
  isSolflare: boolean
}

interface SolflareWalletWindow extends Window {
  solflare?: SolflareWallet;
}

declare const window: SolflareWalletWindow;

export class SolflareWalletAdapter extends BaseAdapter {
  name: string = 'Solflare';
  url: string = 'https://solflare.com';
  icon =
