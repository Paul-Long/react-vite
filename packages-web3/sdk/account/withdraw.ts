...
export function withdraw(program?: Program<RatexContracts> | null, publicKey?: PublicKey | null) {
  return new Promise(async function (resolve, reject) {
    try {
      ...
      const tx = await program?.rpc.withdraw(marginIndex, amount, reduceOnly, depositRecordId, {
        accounts: {
