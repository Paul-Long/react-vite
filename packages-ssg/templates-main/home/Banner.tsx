    ...
    <StyledBanner className="flex flex-col items-center mt-58px sm:mt-90px">
      <div className="content flex flex-col-reverse px-24px sm:px-0 sm:flex-row">
        <div className="flex flex-col justify-center gap48px">
          ...
          <div className="flex flex-row items-center font-light justify-between gap48px max-w100% sm:inline-flex sm:justify-start">
            <div className="flex-1 df fdc gap8px text-center sm:text-left sm:flex-none">
              <span className="font-size-18px sm:font-size-30px line-height-120%">$4,039,036</span>
              <span className="font-size-12px text-gray-500">{LG(lang.TotalValueLocked)}</span>
            </div>
            ...
            <div className="flex flex-col flex-1 gap8px text-center sm:text-left sm:flex-none">
              <span className="font-size-18px sm:font-size-30px line-height-120%">$4,039,036</span>
              <span className="font-size-12px text-gray-500">{LG(lang.TotalTradingVolume)}</span>
            </div>
          </div>
