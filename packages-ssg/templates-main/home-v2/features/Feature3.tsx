...
import data from '../animation/feature3/data.json';
...
const Landing = styled.div`
  ...
  &::after {
    ...
    animation: slide-down 1.8s forwards ease-in-out;
  }
...
export function Feature3({title, desc, mDesc, className, speed}: any) {
