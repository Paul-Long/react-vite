...
import data from '../animation/feature1/data.json';
...
const Landing = styled.div`
  ...
  &::after {
    ...
    animation: slide-down 1.2s forwards ease-in-out;
  }
...
export function Feature1({title, desc, mDesc, className, speed}: any) {
