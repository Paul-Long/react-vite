...
export function UniversalPool() {
  ...
  return (
    <div className="flex flex-col mt-38px">
      <div className="font-size-16px lh-20px fw-semibold">{LG(lang.UniversalLiquidityPool)}</div>
      <div className="grid grid-cols-5">
        ...
        <div className="contents group cursor-default">
          <div
            className={clsx(
          ...
          <div
            className={clsx('flex justify-right py-20px  group-hover:bg-gray-80', [
              select && 'bg-gray-80',
            ])}
          >
