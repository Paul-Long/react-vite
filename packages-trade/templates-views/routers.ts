...
export const routers: RouteType[] = [
  ...
  {slug: '/trade', loader: () => import('./views/trade/trade-yield')},
  {slug: '/trade/:contract', loader: () => import('./views/trade/trade-yield')},
  ...
  {slug: '/liquidity/slp', loader: () => import('./views/trade/liquidity-slp')},
  {slug: '/liquidity', loader: () => import('./views/trade/liquidity')},
  {slug: '/account', loader: () => import('./views/account')},
